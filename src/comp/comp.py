...
c = [human.name for human in humans if ord(human.name[0]) in list(range(ord("C"), ord("G")+1))]
print(c)
...
f = [(human.name, human.age) for human in humans if 27 <= human.age and human.age <= 32]
print(f)
